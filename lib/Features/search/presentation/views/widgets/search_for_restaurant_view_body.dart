...
import 'package:travanix/Features/search/presentation/views/widgets/search_for_restaurant_list.dart';
...
class SearchForRestaurantViewBody extends StatelessWidget {
  const SearchForRestaurantViewBody({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SearchForRestaurantCubit,SearchForRestaurantState>(
      builder:(context,state) {
        var cubit=SearchForRestaurantCubit.get(context);
